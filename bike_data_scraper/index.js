...
exports.handler = async (event, context) => {
    ...
    let url = "https://data.goteborg.se/SelfServiceBicycleService/v2.0/Stations/{APPID}?getclosingperiods={CLOSINGPERIODS}&latitude={LATITUDE}&longitude={LONGITUDE}&radius={RADIUS}&format={FORMAT}";
