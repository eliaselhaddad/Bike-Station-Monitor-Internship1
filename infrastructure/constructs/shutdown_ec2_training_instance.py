...
class ShutdownEC2TrainingInstance(Construct):
    def __init__(
        self,
        scope: Construct,
        id_: str,
        ...
        # lambda setup
        lambda_name = (
            f"{stage_name}-{service_short_name}-shutdown-ec2-training-instance"
        )
        ...
        self.shutdown_ec2_training_instance_lambda = self._build_lambda(
    ...
    def _build_lambda(
        ...
        lambda_function = aws_lambda.Function(
            ...
            handler="bike_data_scraper/handlers/shut_down_ec2_training_instance.lambda_handler",
